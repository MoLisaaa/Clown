        ...
        <div class="container py-2 px-4">
            <!--navbar brand-->
                <a href="#" class="navbar-brand mb-0 h1">
                    <img class="img-fluid" src="{{ Vite::asset('resources/images/image/logo-white.svg') }}"logo" style="width: 40px;">
                </a>
                    ...
                    <ul class="navbar-nav flex-row flex-wrap ms-md-auto">
                        ...
                        <div class="dropdown" data-bs-theme="light">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                ...
                                <li><button class="dropdown-item" type="button"><small><i class="bi bi-circle-half me-2"></i>Auto</small></button></li>
                            </ul>
                        </div>
                        </li>
                    </ul>
        ...
        <div class="container py-5 px-4">
            <div class="row">
                <div class="col-md-5 order-md-2">
                    <img class="img-fluid" src="{{ Vite::asset('resources/images/image/main.svg') }}" alt="main logo">
                </div>
                <div class="col-md-7 order-md-1">
                    <h1 class="mt-4 display-3">Build fast, responsif sites with bootstrap</h1>
                    <p class="fs-5 mt-3">Quickly design and costomize responsif mobile-firs sites with Bootstrap, world's most popular front-end open source toolkit, featuring Sass variables and mixins, responsive grid system, extensive prebuilt component, and powerful JavaScript plugins.</p>
                    <div class="row">
    ...
    <div id="bs-icons">
        ...
        <div class="container py-5 px-4">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <img class="img-fluid" src="{{ Vite::asset('resources/images/image/bs-icons.png') }}" alt="bootstrap-icons">
                </div>
            </div>
        </div>
    ...
    <div id="bs-themes">
        ...
        <div class="container py-5 px-4">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <img class="img-fluid" src="{{ Vite::asset('resources/images/image/bs-themes.png') }}" alt="Bootstrap Themes">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-3 mb-5">
                    <a href="" class="logo text-decoration-none">
                        <div class="d-flex">
                            <img src="{{ Vite::asset('resources/images/image/logo-black.svg') }}" alt="" class="img-fluid" style="width: 40px;">
